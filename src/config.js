...
const setEmojiFormat = (emojiFormat) => config.set(constants.EMOJI_FORMAT, emojiFormat)
const setIssueFormat = (issueFormat) => config.set(constants.ISSUE_FORMAT, issueFormat)
const setSignedCommit = (signedCommit) => config.set(constants.SIGNED_COMMIT, signedCommit)
